...
object AppConstants {
    const val FLUTTER_METHOD_CHANNEL_FG: String = "com.nlp.digitox.methodchannel.fg"
    const val FLUTTER_METHOD_CHANNEL_BG: String = "com.nlp.digitox.methodchannel.bg"
    ...
    // Extra intent data
    const val INTENT_EXTRA_IS_SELF_RESTART: String = "com.nlp.digitox.intent.extra.isSelfRestart"
