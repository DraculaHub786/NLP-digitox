...
class AppLocalizationsSr extends AppLocalizations {
  ...
  String get permission_sheet_privacy_info =>
      'NLP digitox је 100% сигуран и ради ван мреже. Не прикупљамо, нити чувамо било какве личне податке.';
  ...
  String get permission_grant_step_two =>
      '2. Изабери NLP digitox на следећем екрану.';
  ...
  String get permission_alarms_info =>
      'Молимо те да одобриш дозволу за постављање аларма и подсећања. Ово ће омогућити NLP digitox да на време започне твој распоред за спавање. Такође, апликација ће дневно ресетовати тајмере у поноћ и помоћи ти да останеш на правом путу.';
  ...
  String get permission_usage_info =>
      'Молимо дозволите приступ подацима о коришћењу. Ово ће омогућити да NLP digitox прати употребу апликација и управља приступом одређеним апликацијама, обезбеђујући фокусираније и контролисаније дигитално окружење.';
  ...
  String get permission_accessibility_info =>
      'Молимо одобрите дозволу за приступачност. Ово ће омогућити апликацији NLP digitox да ограничи приступ кратком видео садржају (нпр. Reels, Shorts) у оквиру апликација друштвених мрежа и интернет прегледача, као и да филтрира непримерене веб-сајтове.';

  @override
  String get permission_accessibility_required =>
      'NLP digitox захтева дозволу за приступачност како би ефикасно блокирао кратки садржај и веб-сајтове.';
  ...
  String get permission_dnd_info =>
      'Дозволи приступ за режим „Не ометај“. Ово ће омогућити NLP digitox да покрене и заустави режим „Не ометај“ током распореда за спавање.';
  ...
  String get permission_vpn_info =>
      'Одобри дозволу за креирање виртуелне приватне мреже (VPN). Ово ће омогућити апликацији NLP digitox да ограничи приступ интернету за одређене апликације креирањем локалне VPN мреже на уређају.';
  ...
  String get permission_notification_access_info =>
      'Молимо те да одобриш дозволу за приступ обавештењима. Ово ће омогућити NLP digitox да организује твоја обавештења и достави их по твом распореду.';

  @override
  String get permission_notification_access_required =>
      'Апликација NLP digitox захтева приступ обавештењима како би груписао и заказивао обавештења.';
  ...
  String get development_dialog_info =>
      'NLP digitox је тренутно у развоју и могуће је да садржи грешке или непотпуне функције. Ако наиђеш на проблем, пријави га како бисмо могли да побољшамо апликацију.\n\nХвала на повратним информацијама!';
  ...
  String get donation_card_info =>
      'NLP digitox је бесплатна апликација отвореног кода, развијана месецима уз велику посвећеност. Ако ти је била од помоћи, донација би нам значила пуно. Сваки допринос нам помаже да наставимо са унапређивањем и одржавањем апликације за све.';
  ...
  String get app_restart_dialog_info =>
      'NLP digitox ће се аутоматски поново покренути када се одбројавање заврши. Молимо за стрпљење док се измене примењују.';

  @override
  String get accessibility_tip =>
      'Желиш паметније блокирање које троши мање батерије? Одобри дозволу за приступачност за апликацију NLP digitox да би све радило боље и ефикасније.';

  @override
  String get battery_optimization_tip =>
      'NLP digitox не ради како треба?\nДозволи „Игнориши оптимизацију батерије“ у подешавањима како би NLP digitox несметано радио у позадини.';
  ...
  String get glance_usage_tip =>
      'Желиш увид у своје навике?\nNLP digitox нуди одељак преглед где можеш да сазнаш како проводиш време на телефону.';

  @override
  String get tamper_protection_tip =>
      'Желиш да деинсталираш NLP digitox? Прво укључи прозор за деинсталацију да би безбедно искључио заштиту од уклањања.';

  @override
  String get notification_blocking_tip =>
      'Желиш мање ометања? NLP digitox ти нуди опцију блокирања обавештења како би утишао жељене апликације.';
  ...
  String get onboarding_page_one_info =>
      'Паузирај апликације које те ометају, блокирај кратак садржај и остани фокусиран уз флексибилне фокус сесије. Без обзира да ли радиш, учиш или се одмараш, NLP digitox ти помаже да задржиш контролу.';
  ...
  String get onboarding_page_three_info =>
      'NLP digitox је у 100% отвореног кода и ради потпуно офлајн. Не прикупљамо нити делимо било какве личне податке — твоја приватност је у потпуности загарантована.';
  ...
  String get onboarding_page_permissions_info =>
      'NLP digitox захтева следеће основне дозволе како би могао да прати и управља временом проведеним испред екрана, смањи ометања и побољша фокус.';
  ...
  String get protected_access_tile_subtitle =>
      'Заштити апликацију NLP digitox помоћу закључавања уређаја.';
  ...
  String get tamper_protection_confirmation_dialog_info =>
      'Када буде омогућено, нећеш моћи да деинсталираш, принудно зауставиш или очистиш податке апликације NLP digitox, осим током изабраног периода за деинсталацију. Нема заобилазних решења.\n\nНастави на своју одговорност.';
  ...
  String get service_stopping_warning =>
      'Ако NLP digitox престане да ради изненада, молимо те да доделиш дозволу \'Игнориши оптимизацију батерије\' како би апликација наставила да ради у позадини. Ако то не реши проблем, покушај да ставиш NLP digitox на белу листу за неометан рад.';

  @override
  String get whitelist_app_tile_title => 'Додај NLP digitox на белу листу';

  @override
  String get whitelist_app_tile_subtitle =>
      'Одобри да се NLP digitox аутоматски покреће.';
