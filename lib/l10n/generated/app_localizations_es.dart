...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get permission_sheet_privacy_info =>
      'NLP digitox es 100% seguro y funciona sin conexión. No recopilamos ni almacenamos datos personales.';
  ...
  String get permission_grant_step_two =>
      '2. Seleccione NLP digitox en la siguiente pantalla.';
  ...
  String get permission_alarms_info =>
      'Por favor, concede permisos para configurar alarmas y recordatorios. Esto permitirá que NLP digitox inicie tu horario de sueño a tiempo, reinicie los temporizadores de la aplicación diariamente a medianoche y te ayude a mantener el control.';
  ...
  String get permission_usage_info =>
      'Por favor, concede permiso de acceso de uso. Esto permitirá a NLP digitox monitorizar el uso de aplicaciones y gestionar el acceso a ciertas apps, asegurando un entorno digital más enfocado y controlado.';
  ...
  String get permission_overlay_info =>
      'Por favor, concede el permiso de superposición de pantalla. Esto permitirá a NLP digitox mostrar una superposición cuando se abra una aplicación en pausa, ayudándote a mantenerte centrado y así mantener su horario.';
  ...
  String get permission_accessibility_info =>
      'Por favor, concede el permiso de accesibilidad. Esto permitirá a NLP digitox restringir el acceso al contenido de \"vídeo corto\" (P. ej., Reels, Shorts) dentro de las apps de redes sociales y los navegadores, y filtrar sitios web inapropiados.';

  @override
  String get permission_accessibility_required =>
      'NLP digitox requiere permiso de accesibilidad para bloquear de forma efectiva el contenido corto y los sitios web.';

  @override
  String get permission_accessibility_device_tile_label => 'Usar NLP digitox';
  ...
  String get permission_dnd_info =>
      'Por favor, concede acceso a No molestar. Esto permitirá a NLP digitox iniciar y detener el modo No molestar durante el horario de sueño.';
  ...
  String get permission_vpn_info =>
      'Por favor, concede el permiso para crear una conexión de Red Privada Virtual (VPN). Esto permitirá a NLP digitox restringir el acceso a internet para las aplicaciones designadas creando una VPN local en el dispositivo.';
  ...
  String get permission_notification_access_info =>
      'Por favor, concede el permiso de acceso a notificaciones. Esto permitirá a NLP digitox organizar tus notificaciones y entregarlas según tu horario.';

  @override
  String get permission_notification_access_required =>
      'NLP digitox requiere acceso a notificaciones para agrupar y programar las mismas.';
  ...
  String get development_dialog_info =>
      'NLP digitox se encuentra actualmente en desarrollo y puede contener errores funciones incompletas. Si encuentras algún problema, por favor, infórmanos para ayudarnos a mejorar.\n\n¡Gracias por tus comentarios!';
  ...
  String get donation_card_info =>
      'NLP digitox es gratuito y de código abierto, desarrollado con meses de dedicación. Si te ha sido útil, tu donación significaría muchísimo para nosotros. Cada contribución nos ayuda a seguir mejorando y manteniéndolo para todos.';
  ...
  String get app_restart_dialog_info =>
      'NLP digitox se reiniciará automáticamente una vez que termine la cuenta regresiva. Por favor, ten paciencia mientras se aplican los cambios.';

  @override
  String get accessibility_tip =>
      '¿Quieres un bloqueo más inteligente y que gaste menos batería? Habilita el permiso de Accesibilidad para NLP digitox.';

  @override
  String get battery_optimization_tip =>
      '¿NLP digitox no funciona? Permite \'Ignorar la optimización de la batería\' en los Ajustes para que siga funcionando sin problemas.';
  ...
  String get tamper_protection_tip =>
      '¿Estas desinstalando NLP digitox? Habilita la Ventana de Desinstalación para desactivar la protección contra manipulaciones de forma segura primero.';
  ...
  String get onboarding_page_one_info =>
      'Pausa las apps que te distraen, bloquea el contenido corto y mantente centrado con sesiones de enfoque personalizables. Ya sea que estés trabajando, estudiando o relajándote, NLP digitox te ayuda a mantener el control.';
  ...
  String get onboarding_page_three_info =>
      'NLP digitox es 100% de código abierto y funciona completamente sin conexión. No recopilamos ni compartimos tus datos personales; tu privacidad está garantizada de todas las maneras.';
  ...
  String get onboarding_page_permissions_info =>
      'NLP digitox requiere los siguientes permisos esenciales para monitorizar y gestionar tu tiempo de pantalla, ayudando a reducir las distracciones y mejorando el enfoque.';
  ...
  String get protected_access_tile_subtitle =>
      'Protege NLP digitox con el desbloqueo de tu dispositivo.';
  ...
  String get tamper_protection_confirmation_dialog_info =>
      'Una vez habilitado, no podrás desinstalar, forzar detención o borrar los datos de NLP digitox, excepto durante la ventana de desinstalación seleccionada. No hay soluciones alternativas.\n\nProcede bajo tu propio riesgo.';
  ...
  String get service_stopping_warning =>
      'Si NLP digitox deja de funcionar inesperadamente, por favor, concede el permiso \"Ignorar Optimización de Batería\" para mantenerlo funcionando en segundo plano. Si el problema persiste, intenta añadir NLP digitox a la lista blanca para un rendimiento ininterrumpido.';

  @override
  String get whitelist_app_tile_title => 'Añadir NLP digitox a la lista blanca';

  @override
  String get whitelist_app_tile_subtitle =>
      'Permitir que NLP digitox inicie automáticamente.';
